...
public class Listner implements IReporter {
	...
	private static final String emailableReportTemplateFile = "Home/workspace/dev-test-selenium-customize/src/test/java/Salus/salus/backOffice/customize-emailable-report-template.html";
	@Override
